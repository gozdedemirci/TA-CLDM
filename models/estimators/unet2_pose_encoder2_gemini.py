...
class UNet2PoseEncoder(nn.Module):
    ...
    def __init__(self, 
        ...
        self.se_projector = nn.Sequential(  
            ...
            nn.Linear(512, 64),
            nn.ReLU(),
            nn.Linear(64, 3)     # Output: [θ (radians), dx, dy]  
        )  
    ...
    def forward(self, x_t, t=None, cond_img=None, condition=None, self_cond=None):
        # x_t [B, C, *]
        # t [B,]
        # condition [B,]
        # self_cond [B, C, *]
        ...
        if (condition is None) or (self.cond_embedder is None):
            ...
            cond_emb, _ = self.cond_embedder(cond_img, condition) # [B, C]
